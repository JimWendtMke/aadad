 ...
 */
@Component({
  selector: 'docs-service-home',
  templateUrl: './service-home.component.html',
  styleUrls: ['../../assets/styles/base-styles.scss']
})
export class CocoaDocsServiceHomeComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.navigation = this.router.events.subscribe((event: any) => {
      if (event instanceof NavigationEnd && event.url.search('base-service')) {
